...
$('#input-file').on('change', () => {
    ...
    if (!archivos || !archivos.length) {
        ...
        $('.modalcrop-content').addClass('active')

        $('.modalcrop').removeClass('remove')
        $('.modalcrop-content').removeClass('remove')
...
$('#close').on('click', () => {
    ...
    $('.modalcrop-content').addClass('remove')

    $('.modalcrop').removeClass('active')
    $('.modalcrop-content').removeClass('active')
})
...
$('#cut').on('click', () => {
    ...
    let image = document.getElementById('img-cropper')
    let input = document.getElementById('input-file')
    let user_da = document.getElementById('userval').value
    let img_sample = document.querySelector('.img-sample')
    let imgSrc = cropper
        .getCroppedCanvas({
            width: img_sample.value, // input value
        })
        .toDataURL();
...
function save_prof(imglnk, userid) {
